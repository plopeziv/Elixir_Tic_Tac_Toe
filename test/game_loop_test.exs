defmodule GameLoopTest do
  ...
  test "Print Board" do
    ...
    assert capture_io(fn -> GameLoop._print_board(possible_inputs) end) == expected_output
  end
  ...
  test "Computer Turn prints computer board" do
    ...
    assert capture_io(fn -> GameLoop._computer_turn(possible_inputs, "A") end) == expected_output
  end
  ...
  test "Computer Turn returns replaced List" do
    ...
    assert GameLoop._computer_turn(possible_inputs, "A") == [
  ...
  test "User turn should return augmented list" do
    ...
    Mock.with_mock IO, [:passthrough], [gets: fn(_prompt) -> "5" end] do
      return_value = GameLoop._user_turn(possible_inputs, "A")
